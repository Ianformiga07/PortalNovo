    ...
    <div class="container">
      <nav class="breadcrumbs">
        <ol>
          ...
          <li class="current">Resoluções</li>
        </ol>
      </nav>
      <h1>Resoluções</h1>
    <!-- Ícone de Voltar -->
        ...
        <table class="table table-striped">
          ...
          <tbody>
            <tr>
              ...
              <td>06/12/1997</td>
              <td>
                <a href="#" class="btn-visualizar" title="Visualizar Documento" data-toggle="modal" data-target="#resolucoes">
...
<!-- Modal for Denúncia -->
<div class="modal fade" id="resolucoes" tabindex="-1" role="dialog" aria-labelledby="resolucoesLabel" aria-hidden="true">
  <div class="modal-dialog custom-modal-dialog" role="document"> <!-- Classe personalizada adicionada aqui -->
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="resolucoesLabel">Resoluções</h5>
      ...
      <div class="modal-body">
        <div class="document-card">
          ...
          <div class="document-details">
            <p><strong>Tipo de Documento:</strong> Resoluções</p>

...
Dim protocolo, sql, rs_resposta, conn

' Conexão com o banco de dados
Set conn = Server.CreateObject("ADODB.Connection")
conn.Open "Provider=SQLOLEDB;Data Source=IANFORMIGA;Initial Catalog=SeuBancoDeDados;User ID=SeuUsuario;Password=SuaSenha;"

    ...
    <div class="container">
      <nav class="breadcrumbs">
        <ol>
          ...
          <li class="current">Lei Orgânica</li>
        </ol>
      </nav>
      <h1>Lei Orgânica</h1>
    <!-- Ícone de Voltar -->
        ...
        <table class="table table-striped">
          ...
          <tbody>
            <tr>
              ...
              <td>06/12/1997</td>
              <td>
                <a href="#" class="btn-visualizar" title="Visualizar Documento" title="Visualizar Documento" data-toggle="modal" data-target="#lei-organica">
            ...
            <tr>
              ...
              <td>10/02/2023</td>
              <td>
                <a href="#" class="btn-visualizar" title="Visualizar Documento" data-toggle="modal" data-target="#lei-organica">
                  <i class="fas fa-eye fa-1x"></i>
                </a>
                <a href="#" class="btn-visualizar" title="Baixar Documento">
                  <i class="fas fa-download fa-1x"></i>
...
<!-- Modal for Denúncia -->
<div class="modal fade" id="lei-organica" tabindex="-1" role="dialog" aria-labelledby="lei-organicaLabel" aria-hidden="true">
  <div class="modal-dialog custom-modal-dialog" role="document"> <!-- Classe personalizada adicionada aqui -->
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="lei-organicaLabel">lei-organica</h5>
